...
const benefits = [
  {
    ...
    description:
      'Practical expertise across IT, networking, and industrial technology environments.',
    icon: FiUsers,
  },
  {
    title: 'Reliable Solutions',
    description:
      'Technology recommendations selected for performance, continuity, and long-term value.',
    icon: FiCheckCircle,
  },
  {
    title: 'Customer-Focused Support',
    description:
      'Clear communication and responsive support built around your business requirements.',
    icon: FiHeadphones,
  },
  {
    title: 'Quality & Technical Expertise',
    description:
      'A quality-minded approach backed by thoughtful technical planning and delivery.',
    icon: FiWifi,
  },
]
  ...
  return (
    ...
    >
      {Array.from({ length: 6 }, (_, index) => (
        <div
          key={index}
          className="h-80 animate-pulse rounded-md bg-[#F5F5F5]"
        />
      ))}
    </div>
  )
...
function ServiceCard({ service }) {
  return (
    <article className="mifra-card group flex h-full flex-col items-center p-7 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      <div className="flex h-20 w-20 items-center justify-center rounded-full border border-[#E5E5E5] bg-white transition-all duration-300 group-hover:border-[#D4AF37] group-hover:bg-[#D4AF37]">
        <FiServer
          className="text-4xl text-[#D4AF37] transition-colors duration-300 group-hover:text-black"
          aria-hidden="true"
        />
      </div>
      ...
      >
        <div className="mifra-container">
          ...
          <p className="mt-4 max-w-2xl text-base leading-7 text-[#666666]">
            Professional technology and business solutions tailored to your
            needs.
          </p>
        </div>
      </section>
        ...
        <div className="mifra-container">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-base leading-7 text-[#666666]">
              Explore practical services that support your technology and
              business goals.
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-md bg-[#F5F5F5] px-6 py-16 text-center">
              ...
              <button
                ...
                className="mifra-btn-outline mt-6 min-h-12 px-5 text-sm"
              >
                Retry
              </button>
            </div>
        ...
        <div className="mifra-container">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-base leading-7 text-[#666666]">
              Reliable support and technical thinking for every stage of your
              technology journey.
            </p>
          </div>
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {benefits.map((benefit) => {
              ...
              return (
                <article
                  key={benefit.title}
                  className="rounded-md bg-white p-6 shadow-[0_2px_8px_rgba(0,0,0,0.1)]"
                >
                  <Icon
