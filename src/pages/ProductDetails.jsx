...
function LoadingState() {
  return (
    <div
      className="mifra-container animate-pulse py-16"
  ...
  return (
    <span
      className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${
        stockClasses[status] || 'bg-[#666666] text-white'
      }`}
    >
      {status}
    </span>
  ...
  useEffect(() => {
    ...
    const loadProduct = async () => {
      ...
      try {
        ...
        const stockQuantity =
          Number(apiProduct?.stockQuantity) || 0

        const lowStockThreshold =
          Number(apiProduct?.lowStockThreshold) || 0

        // Get category name from category ID
        let resolvedCategoryName = apiProduct?.category || ''
        ...
        try {
          ...
          const category = Array.isArray(categories)
            ? categories.find(
                (item) =>
                  item?.id === apiProduct?.category ||
                  item?._id === apiProduct?.category
              )
            : null
  ...
  return (
    <div className="bg-white">
      <div className="mifra-container py-6 sm:py-8">
        ...
        >
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li>
              <Link
                to="/"
                className="transition-colors hover:text-[#D4AF37] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#D4AF37]"
              >
                Home
              </Link>
            </li>
        ...
        {/* Product */}
        <section
          className="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:gap-16"
        ...
        >
          ...
          <div>
            ...
            <div
  className="mt-4 flex h-20 w-20 items-center justify-center rounded border-2 border-[#D4AF37] bg-white p-3"
...
>
          ...
          <div className="flex flex-col justify-center">
            ...
            <button
              ...
              className="mifra-btn-primary mt-8 min-h-12 w-full sm:w-fit"
            >
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between rounded-md bg-white px-5 py-4 shadow-[0_2px_8px_rgba(0,0,0,0.1)]">
                ...
                <button
                  ...
                  className="rounded p-2 text-[#666666] transition-colors hover:bg-[#F5F5F5] hover:text-[#1a1a1a]"
        ...
        >
          ...
          <div>
            ...
            <dl className="mt-5 divide-y divide-[#E0E0E0] rounded-md border border-[#E0E0E0]">
              ...
              {/* Category */}
              <div className="grid grid-cols-1 gap-1 px-4 py-4 sm:grid-cols-[minmax(140px,0.35fr)_1fr] sm:gap-5">
                <dt className="text-sm font-semibold text-[#1a1a1a]">
                  Category
                </dt>

                <dd className="text-sm text-[#666666]">
                  {categoryName}
                </dd>
              </div>
